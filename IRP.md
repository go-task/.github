...
notify the other maintainers via a secure and private channel. This ensures that
all maintainers are able to contribute to the issue where possible.
...
- Open a draft [GitHub Security Advisory
  (GHSA)](https://github.com/go-task/task/security/advisories) in the Task
  repository.
